    ...
    <div class="container">
        <div class="row space-top">
            ...
            <div class="col-sm-8 space-bottom">
                ...
                <div class="row">
                    <form class="col-md-12 personal-info" action="{{ url('auth/register')  }}" method="post">
                    {!! csrf_field() !!}
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label for="api_first_name">Nome</label>
                                <input type="text" class="form-control" name="nome" value="{{old('nome')}}" id="api_first_name" placeholder="Digite seu nome" required>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="api_last_name">Sobrenome</label>
                                <input type="text" class="form-control" name="sobrenome" value="{{old('sobrenome')}}" id="api_last_name" placeholder="Digite o sobrenome" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-sm-6">
                                <label for="api_email">Email</label>
                                <input type="email" class="form-control" name="email" value="{{old('email')}}" id="api_email" placeholder="Email" required>
                            </div>
                            <div class="form-group col-sm-6">
