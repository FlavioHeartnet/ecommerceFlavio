                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <a class="media-link" href="#">
                            ...
                            <img src="{{asset('img/media/6.jpg')}}" alt="6"/>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <a class="media-link" href="#">
                            ...
                            <img src="{{asset('img/media/7.jpg')}}" alt="7"/>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <a class="media-link" href="#">
                            ...
                            <img src="{{asset('img/media/8.jpg')}}" alt="8"/>
                        </a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <a class="media-link" href="#">
                            ...
                            <img src="{{asset('img/media/9.jpg')}}" alt="9"/>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <a class="media-link" href="#">
                            ...
                            <img src="{{asset('img/media/10.jpg')}}" alt="10"/>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <a class="media-link" href="#">
                            ...
                            <img src="{{asset('img/media/11.jpg')}}" alt="11"/>
                        </a>
                    </div>
                </div>
            </div>
